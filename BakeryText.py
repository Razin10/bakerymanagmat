...
class BakeryManagementSystem:
    ...
    def export_to_txt(self, filename="bakery_orders.txt"):  # Changed to export to TXT
        ...
        print(f"Orders exported to text file: {filename}")
...
while True:
    ...
    print("4. Export Orders to TXT")  # Changed to TXT output
    print("5. Exit")
    ...
    if choice == 1:
        ...
        bakery_system.export_to_txt()  # Call export_to_txt function
    elif choice == 5:
        break
    else:
